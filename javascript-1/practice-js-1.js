...
const me = {
  ...
  state: 'Utah',
  age: 18,
  greeter: () => `Hello! My name is ${me.name} and I live in ${me.state}`
}
...
const isItBob = (obj, func) => {
  return obj.name === 'Bob' ? func(true) : func(false)
}
